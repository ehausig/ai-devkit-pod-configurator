...
# Define functions based on mode
...
# Export functions for use in actors
if [ "$ACTOR_RUNTIME_MODE" = "test" ]; then
    # Test mode exports
    export -f actor_loop
    export -f cleanup_actor
    export -f should_handoff
    export -f perform_handoff
    export -f execute_command
    export -f create_file_with_content
