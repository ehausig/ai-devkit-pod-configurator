...
if [ $PENDING_COUNT -gt 0 ]; then
    ...
    echo "2. Mark each as completed with: es-journal-log.sh 'WORK:COMPLETED' 'ARCHITECT: [work description]'"
    echo "3. Run persona-architect-handoff.sh when all work is complete"
