#!/bin/bash
# SBT-specific repositories file generator with authentication support
set -euo pipefail
...
# Generate SBT repositories file content
{
    ...
    echo "# ivy-local: file://${user.home}/.ivy2/local, [organization]/[module]/(scala_[scalaVersion]/)(sbt_[sbtVersion]/)[revision]/[type]s/[artifact](-[classifier]).[ext]"
    echo "# local"
} > "$OUTPUT_FILE"