...
- **wash** - wasmCloud Shell for project management and deployment (installed via cargo)
...
- **wash**: Downloaded as prebuilt binary from GitHub releases (latest version compatible with wasmCloud 1.9+)
