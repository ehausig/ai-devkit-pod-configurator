...
- **wash** - wasmCloud Shell for project management and deployment (installed via prebuilt binaries)
...
- **wash**: Installed using official prebuilt binaries install script (ensures latest version for wasmCloud 1.9+)
