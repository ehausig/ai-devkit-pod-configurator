...
echo "4. Check that ~/.config/ai-devkit contains the README"
echo ""
echo "Expected results:"
echo "- No ~/.claude directory"
echo "- No language-specific config files (.npmrc, .pip.conf, etc.)"
echo "- ~/.config/ai-devkit/README.md present"
echo ""
echo "Note: The README is restored at runtime since PVC mounts override"
echo "the Docker image contents. Check container logs for:"
